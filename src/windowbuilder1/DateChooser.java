/*
 * This is the modified code of a existed DateChooser class
 * this class provide a visible date chooser window.
...
public class DateChooser extends JPanel {
	...
	private Date initDate;    // use outside, so set public
	...
	private class JP2 extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			g.setFont(font);
			g.drawString("  Su     Mo     TU     WN     TH     FR    SAT ", 5, 10);  // WEEK
	...
	private class JP4 extends JPanel {
		...
		public JP4() {
			...
			final JLabel jl = new JLabel("TODAT: " + sdf.format(new Date()));
			jl.setToolTipText("Click to get date");
